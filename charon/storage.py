...
class S3Client(object):
    ...
    def __init__(
        ...
        self.__client: ServiceResource = self.__init_aws_client(aws_profile, extra_conf)
    ...
    def upload_files(
        ...
        extra_prefixed_buckets: List[Tuple[Bucket, str]] = []
        ...
        async def path_upload_handler(
            ...
            async with self.__con_sem:
                ...
                main_file_object: Object = main_bucket.Object(main_path_key)
                existed = False
                try:
                ...
                for target_ in extra_prefixed_buckets:
                    ...
                    file_object: Object = extra_bucket.Object(extra_path_key)
    ...
    def upload_metadatas(
        ...
        async def path_upload_handler(
            ...
            async with self.__con_sem:
                ...
                file_object: Object = bucket.Object(path_key)
                existed = False
                try:
                    existed = await self.__run_async(self.__file_exists, file_object)
                except (ClientError, HTTPClientError) as e:
    ...
    def upload_manifest(
        ...
        try:
            file_object: Object = manifest_bucket.Object(path_key)
    ...
    def __get_bucket(self, bucket_name: str) -> Bucket:
        self.__lock.acquire()
        try:
